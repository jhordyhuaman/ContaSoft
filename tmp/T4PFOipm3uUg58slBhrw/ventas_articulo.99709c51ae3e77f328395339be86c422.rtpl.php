            ...
            <table class="table table-hover">
               <thead>
                  <tr>
                     ...
                     <th>Combinación</th>
                     <th width="200" class="text-right">Impacto en el precio</th>
                     <th width="120"></th>
                  </tr>
               </thead>
               ...
               <form action="<?php echo $fsc->url();?>#atributos" method="post" class="form">
                  ...
                  <tr>
                     ...
                     <td>
                        <div class="input-group">
                           <input type="number" step="any" name="impactoprecio" value="<?php echo $value1->impactoprecio;?>" class="form-control text-right" autocomplete="off" required=""/>
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       <input type="number" step="any" class="form-control text-right" name="impactoprecio" value="0" autocomplete="off" required=""/>
                                       <span class="input-group-addon"><?php echo $fsc->simbolo_divisa();?></span>
                                    </div>
                                    <p class="help-block">
                                       Se le sumará al precio del artículo. Si quieres que reste
                                       pon un menos delante del número.
                                    </p>
                                 </div>
