      ...
      <div class="col-sm-4 col-xs-6 text-right">
         ...
         <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
               ...
               <li>
                  <a href="<?php echo $fsc->url(TRUE);?>&order=vencimiento_desc">
                     <span class="glyphicon glyphicon-sort-by-attributes-alt" aria-hidden="true"></span>
                     &nbsp; Vencimiento &nbsp;
                     <?php if( $fsc->order=='vencimiento DESC' ){ ?><span class="glyphicon glyphicon-ok" aria-hidden="true"></span><?php } ?>

                  </a>
               </li>
               <li>
                  <a href="<?php echo $fsc->url(TRUE);?>&order=vencimiento_asc">
                     <span class="glyphicon glyphicon-sort-by-attributes" aria-hidden="true"></span>
                     &nbsp; Vencimiento &nbsp;
                     <?php if( $fsc->order=='vencimiento ASC' ){ ?><span class="glyphicon glyphicon-ok" aria-hidden="true"></span><?php } ?>
...
<div class="table-responsive">
   <table class="table table-hover">
      ...
      <tr class="clickableRow<?php if( $value1->vencida() OR $value1->anulada ){ ?> danger<?php }elseif( $value1->pagada ){ ?> success<?php }elseif( $value1->total<=0 ){ ?> warning<?php } ?>" href="<?php echo $value1->url();?>">
